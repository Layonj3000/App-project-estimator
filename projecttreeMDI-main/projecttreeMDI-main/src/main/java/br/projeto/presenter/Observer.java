...
//MODIFICAR PARA CLASSE ABSTRATA COM IMPLEMENTAÇÕES CONCRETAS
public interface Observer {
    ...
    void updatePerfilProjetoIntermediaria(List<PerfilProjetoIntermediariaModel> listaPerfilProjetoIntermediariaModel);
}
